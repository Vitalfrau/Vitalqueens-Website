...
STYLE = '''
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .post-thumb { height: 200px; overflow: hidden; background: var(--cream-mid); }
    ...
    .post-body h3 { font-family: 'Playfair Display', serif; font-size: 18px; font-weight: 700; color: var(--ink); margin-bottom: 10px; line-height: 1.35; flex: 1; }
    .post-read { font-size: 13px; font-weight: 600; color: var(--forest); display: inline-flex; align-items: center; gap: 4px; transition: gap 0.2s; margin-top: 14px; }
...
CATEGORIES = [
    {
        ...
        'articles': [
            ('29. April 2026', 'Erschöpft bis in die Zellen. Was Mitochondrien mit deiner täglichen Müdigkeit zu tun haben', 'koerperkompass/erschoepft-bis-in-die-zellen-was-mitochondrien-mit-deiner-taeglichen-muedigkeit-zu-tun-haben.html', 'img/mitochondrien.png'),
            ('17. April 2026', 'Darmgesundheit. Wenn du innerlich nichts mehr verdauen kannst', 'koerperkompass/darmgesundheit-wenn-du-innerlich-nichts-mehr-verdauen-kannst.html', 'img/vital.png'),
            ('17. März 2026', 'Früher doof, heute super: Warum ich Nahrungsergänzungsmittel heute mit anderen Augen sehe', 'koerperkompass/frueher-doof-heute-super-warum-ich-nahrungsergaenzungsmittel-heute-mit-anderen-augen-sehe.html', 'img/nahrungsergaenzung.png'),
            ('9. März 2026', 'Du schläfst 8 Stunden und bist trotzdem müde?', 'koerperkompass/du-schlaefst-8-stunden-und-bist-trotzdem-muede.html', 'img/mito-feel.png'),
            ('6. März 2026', 'Hormongleichgewicht bei Frauen: Essenzielle Bedürfnisse des Körpers', 'koerperkompass/hormongleichgewicht-bei-frauen.html', 'img/morgenroutine.png'),
            ('28. März 2026', 'Warum dein Nervensystem dauerhaft unter Strom steht', 'koerperkompass/warum-dein-nervensystem-dauerhaft-unter-strom-steht-und-was-haendigkeit-damit-zu-tun-hat.html', 'img/energieraeuber.png'),
        ]
    },
    {
        ...
        'articles': [
            ('16. April 2026', 'Erschöpft im Business? Dein Darm weiß die Antwort', 'female-business/erschoepft-im-business-dein-darm-weiss-die-antwort.html', 'img/geheimnis.png'),
            ('19. März 2026', '4 Wege, wie wir 2026 zusammenarbeiten können', 'female-business/4-wege-wie-wir-2026-zusammenarbeiten-koennen.html', 'img/4-wege.png'),
            ('19. März 2026', 'Passt das ganzheitliche Konzept zu mir?', 'female-business/passt-das-ganzheitliche-konzept-zu-mir.html', 'img/ganzheitliches-konzept.png'),
            ('18. März 2026', '7 Gründe, warum ich Netzwerken und echte Begegnung liebe', 'female-business/7-gruende-warum-ich-netzwerken-und-echte-begegnung-liebe.html', 'img/netzwerken.png'),
            ('29. Januar 2026', 'Gehen wir in Resonanz?', 'female-business/gehen-wir-in-resonanz%f0%9f%92%83%f0%9f%91%91%f0%9f%92%8e.html', 'img/koerper-kompass.png'),
        ]
    },
    {
        ...
        'articles': [
            ('16. April 2026', 'Spät-Mutter und Wiedereinstieg ins Berufsleben', 'persoenlich/spaet-mutter-und-wiedereinstieg-ins-berufsleben.html', 'img/spaet-mama.png'),
            ('9. März 2026', 'Ostern ohne Stress – 7 schnelle Überraschungen für Kinder', 'persoenlich/ostern-ohne-stress-7-schnelle-ueberraschungen-fuer-kinder-wenn-du-null-energie-hast.html', 'img/ostern.png'),
            ('19. Januar 2026', 'Mein Motto für 2026: Freude am Leben', 'persoenlich/mein-motto-fuer-2026-heisst-freude-am-leben.html', 'img/motto.png'),
            ('21. Januar 2026', 'Meine To-Want-Liste für das 1. Quartal 2026', 'persoenlich/meine-to-want-liste-fuer-das-1-quartal-2026.html', 'img/koerper-kompass.png'),
            ('17. Januar 2026', 'Jahresrückblick 2025: Vom Funktionieren ins bewusste Gestalten', 'persoenlich/jahresrueckblick-2025.html', 'img/jahresrueckblick.png'),
        ]
    },
]

def make_card(date, title, url, img, cat_class, cat_label):
    return f'''    <a href="{url}" class="post-card">
...
for cat in CATEGORIES:
    cards = '\n'.join(make_card(d, t, u, i, cat['cat_class'], cat['cat_label']) for d, t, u, i in cat['articles'])
    html = f'''<!DOCTYPE html>
<html lang="de">
<head>
  <meta charset="UTF-8">
...
<main class="page-content">
  <span class="section-label">Alle Beiträge</span>
  <h2 class="section-heading">Artikel in dieser Kategorie</h2>
...
function toggleMenu() {{ document.body.classList.toggle('nav-mobile-open'); }}
    ...
    with open(path, 'w', encoding='utf-8') as f:
        f.write(html)
    print(f'Updated: {cat["file"]} ({len(cat["articles"])} articles)')
